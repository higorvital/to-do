...
}, _dec3 = Reflect.metadata("design:type", Function), _dec4 = Reflect.metadata("design:paramtypes", [typeof _ITasksRepository.default === "undefined" ? Object : _ITasksRepository.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = class DeleteTaskService {
  constructor(tasksRepository) {
    this.tasksRepository = tasksRepository;
  }

  async execute(user_id, task_id) {
    ...
    if (task.user_id !== user_id) {
      throw new _AppError.default("Essa tarefa não pertence a esse usuário");
    }
