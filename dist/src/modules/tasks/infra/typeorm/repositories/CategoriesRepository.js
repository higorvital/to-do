...
var CategoriesRepository = /** @class */ (function () {
    ...
    CategoriesRepository.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var category;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        category = this.ormRepository.create(data);
    ...
    CategoriesRepository.prototype.findByUser = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            var categories;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CategoriesRepository.prototype.findByNameAndUser = function (name, user_id) {
        return __awaiter(this, void 0, void 0, function () {
            var category;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CategoriesRepository.prototype.save = function (category) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ormRepository.save(category)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, category];
                }
