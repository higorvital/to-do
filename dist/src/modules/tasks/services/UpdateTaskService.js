...
var UpdateTaskService = /** @class */ (function () {
    function UpdateTaskService(tasksRepository, subcategoriesRepository) {
        this.tasksRepository = tasksRepository;
        this.subcategoriesRepository = subcategoriesRepository;
    }
    UpdateTaskService.prototype.execute = function (_a) {
        var user_id = _a.user_id, task_id = _a.task_id, title = _a.title, date = _a.date, time = _a.time, description = _a.description, subcategory_id = _a.subcategory_id;
        return __awaiter(this, void 0, void 0, function () {
            var task, dateTask, dateTimeTask, timeTask, taskTimeUnavailable, subcategory;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.tasksRepository.findById(task_id)];
                    case 1:
                        task = _b.sent();
                        if (!task) {
                            throw new AppError_1.default("Tarefa não existe");
                        }
                        if (task.user_id !== user_id) {
                            throw new AppError_1.default("Tarefa não pertence a esse usuário");
                        }
                        dateTask = new Date(date.year, date.month - 1, date.day);
                        dateTimeTask = new Date(dateTask);
                        timeTask = null;
                        if (!time) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.tasksRepository.findByTime(__assign({ user_id: user_id }, time))];
                    case 2:
                    ...
                    case 3:
                        ...
                        if (!subcategory_id) return [3 /*break*/, 5];
