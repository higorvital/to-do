...
var UpdateUserService = /** @class */ (function () {
    function UpdateUserService(usersRepository, hashProvider) {
    ...
    UpdateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, userWithEmail, passwordCorrect, _b;
                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (userWithEmail && email !== user.email) {
                            throw new AppError_1.default("E-mail já está cadastrado");
                        }
                        user.email = email;
                        user.name = name;
                    ...
                    case 3:
                        passwordCorrect = _c.sent();
                        if (!passwordCorrect) {
                            throw new AppError_1.default("Senha antiga incorreta");
                        }
                        _b = user;
