...
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var data, schema, error_1, name, email, password, createUserService, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        user = _a.sent();
                        return [2 /*return*/, response.status(200).json(class_transformer_1.classToClass(user))];
                }
            });
        });
    };
    UsersController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var data, schema, error_2, updateUserService, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = request.body;
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, updateUserService.execute(__assign(__assign({}, data), { user_id: request.user.id }))];
                    case 5:
                        user = _a.sent();
                        return [2 /*return*/, response.status(200).json(class_transformer_1.classToClass(user))];
                }
