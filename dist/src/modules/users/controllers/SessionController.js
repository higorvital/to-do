...
var SessionController = /** @class */ (function () {
    ...
    SessionController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var data, schema, email, password, authenticateUserService, _a, user, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        if (!(_b.sent())) {
                            throw new AppError_1.default("Dádos inválidos");
                        }
                        email = data.email, password = data.password;
                        authenticateUserService = tsyringe_1.container.resolve(AuthenticateUserService_1.default);
                        return [4 /*yield*/, authenticateUserService.execute(email, password)];
                    case 2:
